...
class BedrockChatApp:
    ...
    def process_request(self, prompt, user_id, session_id):
        ...
        try:
            validated_prompt = self.validate_input(prompt)
            ...
            full_response = self.invoke_bedrock_model_with_streaming(
                validated_prompt, user_id, session_id
            )
    ...
    # (chat_interface and run methods unchanged)